...
export const API_BASE = ' https://narodniyplus.ru/'; // Vercel proxy handles routing to http://84.201.180.219:80/

// export const API_BASE = 'https://narodniyplus.ru/'; // For local dev with backend server
